...
@property (nonatomic, copy) StringResultBlock resultBlock;
// 单列选中的项
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    StringPickerView *strPickerView = [[StringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
