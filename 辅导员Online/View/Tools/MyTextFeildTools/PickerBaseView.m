...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = [UIColor colorWithRed:252/255.0 green:252/255.0 blue:252/255.0 alpha:1];
    }
    return _topView;
}
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.layer.borderColor = [UIColor colorWithRed:80/255.0 green:177/255.0 blue:80/255.0 alpha:1].CGColor;
        _leftBtn.layer.borderWidth = 1.0f;
        _leftBtn.layer.masksToBounds = YES;
        _leftBtn.titleLabel.font = [UIFont systemFontOfSize:15.0f];
        [_leftBtn setTitleColor:[UIColor colorWithRed:80/255.0 green:177/255.0 blue:80/255.0 alpha:1] forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.backgroundColor = [UIColor colorWithRed:80/255.0 green:177/255.0 blue:80/255.0 alpha:1];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = [UIColor colorWithRed:80/255.0 green:177/255.0 blue:80/255.0 alpha:1];
