...
- (void)addHeaderWithHeaderClass:(NSString *)headerClassName beginRefresh:(BOOL)beginRefresh delegate:(id<MJRefreshEXDelegate>)delegate animation:(BOOL)animation textColor:(UIColor *)color activityIndicatorViewStyle:(UIActivityIndicatorViewStyle)activityIndicatorViewStyle{
    ...
    if (headerClassName == nil || [headerClassName isEqualToString:@""]) {
        ...
        header.activityIndicatorViewStyle = activityIndicatorViewStyle;
...
- (void)addFooterWithFooterClass:(NSString *)footerClassName automaticallyRefresh:(BOOL)automaticallyRefresh delegate:(id<MJRefreshEXDelegate>)delegate textColor:(UIColor *)color{
    ...
    if (footerClassName == nil || [footerClassName isEqualToString:@""]) {
       ...
       //     footer.stateLabel.textColor = [UIColor colorWithWhite:0.400 alpha:1.000];
            ...
            [footer setTitle:@"数据已全部加载完毕" forState:MJRefreshStateNoMoreData];
